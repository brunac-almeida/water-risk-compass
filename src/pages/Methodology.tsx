                  ...
                  {[
                    ...
                    <div key={s.n} className="flex flex-col items-center">
                      <div className="w-full text-center">
                        ...
                        <p className="font-display text-[13px] font-bold text-foreground leading-tight">{s.title}</p>
                        <p className="text-[11px] text-slate leading-snug mt-0.5">{s.sub}</p>
                      </div>
                      {i < arr.length - 1 && (
                        <div className="text-teal/40 text-lg font-bold leading-none my-1">↓</div>
                      )}
                    </div>
                  ))}
                </div>

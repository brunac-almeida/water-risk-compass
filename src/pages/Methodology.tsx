          ...
          <div className="border-l-4 border-l-risk-amber p-7">
            ...
            >
              <div>
                ...
                <p className="text-[12.5px] text-slate leading-[1.6]">
                  Read, normalize, and compute scores.
                </p>
              </div>
              <ChevronDown
            ...
            <div className="mt-5 bg-muted/40 border border-border rounded-xl p-3">
              {!showSteps && (
                <p className="text-[12px] text-slate leading-[1.55] text-center px-1 py-1">
                  Read, normalize, and compute scores.
                </p>
              )}
              <div
                className={`grid transition-all duration-300 ease-out ${showSteps ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
              >
                <div className="overflow-hidden">
